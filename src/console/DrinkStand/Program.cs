...
namespace DrinkStand
{
    ...
    {
        /// <summary>
        /// When life gives you lemons, set up a stand
        /// </summary>
        /// <param name="gameName">Name the game whatever you like!</param>
        static void Main(string gameName = GameEngine.GameName)
        {
            // display our game banner and instructions
            Console.Clear();
            DisplayWelcome(gameName, GameEngine.TypicalRetailPrice);
            WaitForEnterPress();
            Console.Clear();
        ...
        static DailyChoices GetDailyUserChoices(int playerNumber)
        {
        ...
        static int GetNumberInputFromConsole(string prompt)
        {
            int number = -1;
        ...
        static void DisplayDailyChoices(PlayerProfile player, DailyChoices choices)
        {
            Console.WriteLine();
        ...
        static void DisplayDailyResults(GameState state)
        {
            Console.Clear();
        ...
        static void DisplayWelcome(string gameName, int typicalPrice)
        {
